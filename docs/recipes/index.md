...
|:---|:---|
| [Add an Attribute](add-attribute.md) | A new replicated attribute with clamping and OnRep |
| [Add an Ability](add-ability.md) | A Blueprint ability child of your base class, granted to a character |
